...
function StatCard({ icon, label, value, delay }) {
  return (
    ...
    >
      <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-gradient-purple to-gradient-pink flex items-center justify-center mb-3">
        {icon}
      </div>
      <span className="text-2xl font-bold text-light-primary">{value}</span>
      <span className="text-sm text-light-secondary/60">{label}</span>
    </motion.div>
  );
}
